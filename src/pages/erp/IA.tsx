...
export default function IA() {
  ...
  const inputCls = 'w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-tdb-green'
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <Card>
          ...
          <form onSubmit={handlePreverFalta} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-xs text-gray-500 font-body block mb-1">Distância (km)</label>
                <input type="number" step="0.1" min="0" {...faltaForm.register('distanciaKm', { valueAsNumber: true })} className={inputCls} />
              </div>
              <div>
                <label className="text-xs text-gray-500 font-body block mb-1">Faltas anteriores</label>
                <input type="number" min="0" {...faltaForm.register('faltasAnteriores', { valueAsNumber: true })} className={inputCls} />
              </div>
              <div>
                <label className="text-xs text-gray-500 font-body block mb-1">Dias até a consulta</label>
                <input type="number" min="0" {...faltaForm.register('diasAteConsulta', { valueAsNumber: true })} className={inputCls} />
              </div>
              <div>
                <label className="text-xs text-gray-500 font-body block mb-1">Renda familiar (R$)</label>
                <input type="number" min="0" {...faltaForm.register('rendaFamiliar', { valueAsNumber: true })} className={inputCls} />
              </div>
              <div>
                <label className="text-xs text-gray-500 font-body block mb-1">Turno</label>
                <select {...faltaForm.register('turno', { valueAsNumber: true })} className={inputCls}>
        ...
        <Card>
          ...
          <form onSubmit={handlePreverArrecadacao} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-xs text-gray-500 font-body block mb-1">Duração (dias)</label>
                <input type="number" min="1" {...arrecForm.register('duracaoDias', { valueAsNumber: true })} className={inputCls} />
              </div>
              <div>
                <label className="text-xs text-gray-500 font-body block mb-1">Meta (R$)</label>
                <input type="number" min="0" {...arrecForm.register('metaValor', { valueAsNumber: true })} className={inputCls} />
              </div>
              <div>
                <label className="text-xs text-gray-500 font-body block mb-1">Campanhas anteriores</label>
                <input type="number" min="0" {...arrecForm.register('campanhasAnteriores', { valueAsNumber: true })} className={inputCls} />
              </div>
              <div>
                <label className="text-xs text-gray-500 font-body block mb-1">Mês do ano (1-12)</label>
                <input type="number" min="1" max="12" {...arrecForm.register('mesDoAno', { valueAsNumber: true })} className={inputCls} />
              </div>
            </div>
